...
import org.daniel.tapia.util.Utileria;
...
public class VacantesController {
	...
	//Data Binding
	@PostMapping("/guardar")
	public String guardar(Vacante vacante, BindingResult result, RedirectAttributes a, @RequestParam("archivoImagen") MultipartFile multiPart, Model model) {
		//guardar en la tabla o la lista
		if (result.hasErrors()) {
		...
		//System.out.println("Número de vacantes: " + serviceVacante.obtenerTodas().size());
		//return "vacantes/listaVacantes";
		//model.addAttribute("msg", "Registro exitoso");
		a.addFlashAttribute("msg", "Registro Exitoso");
